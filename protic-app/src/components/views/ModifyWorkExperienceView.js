...
export const ModifyWorkExperienceView = () => {
    ...
    const { workExperience: form, changeField, toggleVisibility, changeWorkPeriodDate, toggleBinding, loading } = useWorkExperience(workExperienceId);
            ...
            {!loading && !!form &&
                <div className="container">
                    ...
                    <p className="text-justify">
                        Este panel te permite modificar una experiencia laboral.
