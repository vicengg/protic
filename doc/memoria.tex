...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    \begin{figure}
        \centering
        \includegraphics[width=7cm, keepaspectratio]{img/old_vista_inicio_sesión.PNG}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=7cm, keepaspectratio]{img/old_vista_solicitud_negociación.PNG}
    ...
    \begin{figure}
        \centering
        \includegraphics[width=7cm, keepaspectratio]{img/old_vista_detalles_información_laboral_adquirida.PNG}
